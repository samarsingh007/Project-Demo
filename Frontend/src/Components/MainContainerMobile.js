...
import "./CSS/MainContainerMobile.css";
...
const MainContainerMobile = ({ userId, onAppReload, profile, setShowNameModal, isGuest, isMobile, refreshTrigger }) => {
  ...
  return (
    <div className="home-mobile-wrapper">
      ...
      <div
        ...
        >
          <MobileHomePage setShowNameModal={setShowNameModal} profile={profile} userId={userId} isMobile={isMobile} />
        </div>
        <div
          className="chat-container-mobile fade-in"
          style={{
